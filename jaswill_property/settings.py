"""
Django settings for jaswill_property project.
...
SECRET_KEY = 'django-insecure-$t#bjx)yy-)p(!d+29@1vg3#fc^yf9r2vh9-u*$mav!rq!zb+^'
...
WSGI_APPLICATION = 'jaswill_property.wsgi.application'
